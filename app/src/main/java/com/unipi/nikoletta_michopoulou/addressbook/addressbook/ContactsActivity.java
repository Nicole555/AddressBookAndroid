    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myTextBox.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                Cursor cur =db.rawQuery("SELECT * FROM Informations WHERE name LIKE '"+editText5.getText().toString()+"%'  OR lastname LIKE '"+editText5.getText().toString()+"%' OR tel LIKE  '"+editText5.getText().toString()+"%' OR email LIKE  '"+editText5.getText().toString()+"%'",null);
                if(cur.getCount()==0){
